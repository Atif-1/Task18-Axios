...
function getTodos() {
	...
	// 	console.log(err);
	// });
axios.get('https://jsonplaceholder.typicode.com/todos?_limit=5',{timeout:5000})//{params:{_limit:5}} & by default it will be get request even if dont write
...
// 	.catch(err=>console.log(err));
//   
axios.post('https://jsonplaceholder.typicode.com/todos?_limit=5',{title:'new Todo',
	completed:false	 
	}).then(result=>showOutput(result))
.catch(err=>console.log(err));
}
  ...
  // PUT/PATCH REQUEST
  function updateTodo() {
	axios.patch('https://jsonplaceholder.typicode.com/todos/1',{title:'Update Todo',
	completed:false	 
	}).then(result=>showOutput(result))
.catch(err=>console.log(err));
}
  ...
  // DELETE REQUEST
  function removeTodo() {
	axios.delete('https://jsonplaceholder.typicode.com/todos/1').then(result=>showOutput(result))
.catch(err=>console.log(err));
}
  
  // SIMULTANEOUS DATA
  function getData() {
	//axios.all takes array of request
	axios.all([
